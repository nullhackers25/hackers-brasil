...
$tabela = $_GET['tabela'] ?? 'tentativas_cadastro';
...
<head>
    ...
    /* Info-cadastro - ESTILO ESPECÍFICO */
    .info-cadastro {
...
<div class="container">
    <h1><i class="fas fa-user-plus"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="stats-tabela">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">Tentativas de Cadastro</div>
        </div>
        <div class="stat-item">
    ...
    <div class="info-cadastro">
        ...
        <p><strong>Tabela de Tentativas de Cadastro:</strong> Esta tabela registra todas as tentativas de criação de conta no sistema. Essencial para análise de segurança e prevenção de cadastros maliciosos.</p>
    </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome_coluna" name="nome_coluna" required 
                           placeholder="ex: email_tentativa, ip_origem, navegador_usado"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="valor_padrao" name="valor_padrao" 
                           placeholder="ex: NULL, 'pendente', false, now()">
                </div>
            </div>
