...
$tabela = $_GET['tabela'] ?? 'usuarios_pendentes';
...
<head>
    ...
    /* Info-pendente - ESTILO ESPECÍFICO */
    .info-pendente {
...
<div class="container">
    <h1><i class="fas fa-user-check"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="info-pendente">
        ...
        <p><strong>Tabela de Usuários Pendentes:</strong> Esta tabela armazena cadastros que aguardam aprovação ou validação. Essencial para controle de novos usuários e moderação.</p>
    </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome_coluna" name="nome_coluna" required 
                           placeholder="ex: motivo_pendencia, data_solicitacao, status_aprovacao"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="valor_padrao" name="valor_padrao" 
                           placeholder="ex: NULL, 'pendente', now(), 'aguardando'">
                </div>
            </div>
