...
$tabela = $_GET['tabela'] ?? 'logins_bloqueados';
...
<div class="container">
    <h1><i class="fas fa-shield-alt"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="stats-tabela">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">Logins Bloqueados</div>
        </div>
        <div class="stat-item">
    ...
    <div class="info-login">
        ...
        <p><strong>Tabela de Logins Bloqueados:</strong> Esta tabela armazena tentativas de login bloqueadas por segurança. Alterações podem afetar o sistema de proteção contra ataques.</p>
    </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome_coluna" name="nome_coluna" required 
                           placeholder="ex: ip_origem, motivo_bloqueio, data_desbloqueio"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="valor_padrao" name="valor_padrao" 
                           placeholder="ex: NULL, false, 'tentativa_invalida', now()">
                </div>
            </div>
