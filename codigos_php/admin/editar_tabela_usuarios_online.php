...
$tabela = $_GET['tabela'] ?? 'usuarios_online';
...
<div class="container">
    <h1><i class="fas fa-user-clock"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="info-online">
        ...
        <p><strong>Tabela de Usuários Online:</strong> Esta tabela monitora usuários ativos no sistema em tempo real. Essencial para estatísticas de uso e controle de sessões simultâneas.</p>
    </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome_coluna" name="nome_coluna" required 
                           placeholder="ex: ultima_acao, ip_conexao, tempo_sessao"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="valor_padrao" name="valor_padrao" 
                           placeholder="ex: NULL, 'ativo', now(), 0">
                </div>
            </div>
