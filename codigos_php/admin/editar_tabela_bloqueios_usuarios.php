...
$tabela = $_GET['tabela'] ?? 'bloqueios_usuarios';
...
<head>
    ...
    /* Info-bloqueio - ESTILO ESPECÍFICO */
    .info-bloqueio {
...
<div class="container">
    <h1><i class="fas fa-user-slash"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="info-bloqueio">
        ...
        <p><strong>Tabela de Controle de Bloqueios:</strong> Esta tabela armazena informações sobre usuários bloqueados no sistema. Alterações nesta estrutura podem afetar o sistema de segurança.</p>
    </div>
