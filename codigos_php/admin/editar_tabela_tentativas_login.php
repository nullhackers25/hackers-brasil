...
$tabela = $_GET['tabela'] ?? 'tentativas_login';
...
<head>
    ...
    /* Info-tentativa-login - ESTILO ESPECÍFICO */
    .info-tentativa-login {
    ...
    .info-tentativa-login i {
        color: #8a2be2;
        font-size: 1.2rem;
    }
    
    .info-tentativa-login p {
        margin: 0;
        color: #d8bfd8;
    }
...
<div class="container">
    <h1><i class="fas fa-key"></i> Editar Tabela: <?= htmlspecialchars($tabela) ?></h1>
    ...
    <div class="info-tentativa-login">
        <i class="fas fa-exclamation-triangle"></i>
        <p><strong>Tabela de Tentativas de Login:</strong> Esta tabela registra todas as tentativas de acesso ao sistema. Essencial para segurança, detecção de ataques e análise de padrões de acesso.</p>
    </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="nome_coluna" name="nome_coluna" required 
                           placeholder="ex: ip_tentativa, user_agent, resultado_login"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="valor_padrao" name="valor_padrao" 
                           placeholder="ex: NULL, 'falha', now(), 'bloqueado'">
                </div>
            </div>
