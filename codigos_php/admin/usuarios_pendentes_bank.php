...
$sql = "SELECT id, nome_completo, email, usuario, token, ip_cadastro, navegador, sistema_operacional, token_expira_em, criado_em 
...
<div class="container">
    ...
    <div class="painel-acoes">
        ...
        <a href="alterar_tabela.php" class="btn editar-tabela">
        ...
        <table class="tabela">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($linha['token']) ?></td>
                    ...
                    <td><?= htmlspecialchars($linha['token_expira_em']) ?></td>
                    <td><?= htmlspecialchars($linha['criado_em']) ?></td>
                    <td class="acoes">
...
function openEditModal(userId) {
    fetch('usuarios_pendentes_bank.php', {
        method: 'POST',
        headers: {
