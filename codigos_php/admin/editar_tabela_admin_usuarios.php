...
// Definir a tabela (sempre admin_usuarios nesta página)
...
try {
    ...
    $sql_registros = "SELECT COUNT(*) FROM admin_usuarios";
...
<div class="container">
    <h1><i class="fas fa-table"></i> Editar Tabela: admin_usuarios</h1>
    
    <div class="painel-acoes">
        <a href="gerenciar_tabelas.php" class="btn voltar">
            <i class="fas fa-arrow-left"></i> Voltar para Gerenciar Banco de Dados
        </a>
    ...
    <div class="stats-tabela">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">Administradores Cadastrados</div>
        </div>
        <div class="stat-item">
            <div class="stat-numero">admin_usuarios</div>
...
document.getElementById('formNovaColuna').addEventListener('submit', function(e) {
    ...
    formData.append('tabela', 'admin_usuarios');
...
function removerColuna(nomeColuna) {
    if (!confirm(`ATENÇÃO! Você está prestes a remover a coluna "${nomeColuna}" da tabela admin_usuarios.\n\nEsta ação NÃO pode ser desfeita e pode causar perda de dados.\n\nDeseja continuar?`)) {
        return;
    }
